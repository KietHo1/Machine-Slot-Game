...
public class GUIButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    [SerializeField] private Sprite enableSpr, disableSpr, hoverSpr, enableBonusSpr, hoverBonusSpr;
    private int index = 0;
    private Action evt;
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        else
        {
            ...
            if (GameMN.Instance.isBonusSpin() && hoverBonusSpr)
                img.sprite = hoverBonusSpr;
        }
    }
    ...
    public void OnPointerExit(PointerEventData eventData)
    {
        ...
        else
        {
            ...
            if (GameMN.Instance.isBonusSpin() && enableSpr)
                img.sprite = enableBonusSpr;
        }
    }
    ...
    public void Disable(bool disable)
    {
        ...
        else
        {
            ...
            if (GameMN.Instance.isBonusSpin() && enableBonusSpr && disableSpr)
            {
               spr = disable ? disableSpr : enableBonusSpr;
                img.sprite = spr;
            }
    ...
    public void ChangeSpr(Sprite spr)
    {
        img.sprite = spr;
    }
}
